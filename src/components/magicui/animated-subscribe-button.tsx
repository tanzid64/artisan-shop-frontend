    ...
    <AnimatePresence mode="wait">
      {isSubscribed ? (
        <motion.button
          ref={ref}
          className={cn(
            "relative flex h-10 w-fit items-center justify-center overflow-hidden rounded-lg bg-primary px-6 text-primary-foreground disabled:opacity-50 disabled:pointer-events-none",
            className
          )}
        ...
        <motion.button
          ref={ref}
          className={cn(
            "relative flex h-10 w-fit cursor-pointer items-center justify-center rounded-lg border-none bg-primary px-6 text-primary-foreground disabled:opacity-50 disabled:pointer-events-none",
            className
          )}
          onClick={(e) => {
